...
describe('Service Tests', () => {
    ...
    describe('MoneyAccountMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MoneyAccountMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/money-accounts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return MoneyAccountMySuffix', () => {
