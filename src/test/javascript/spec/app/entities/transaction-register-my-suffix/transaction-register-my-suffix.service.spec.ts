...
describe('Service Tests', () => {
    ...
    describe('TransactionRegisterMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TransactionRegisterMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/transaction-registers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TransactionRegisterMySuffix', () => {
