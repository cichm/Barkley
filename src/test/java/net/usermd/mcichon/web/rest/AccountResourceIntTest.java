...
import net.usermd.mcichon.domain.Authority;
import net.usermd.mcichon.domain.User;
import net.usermd.mcichon.repository.AuthorityRepository;
import net.usermd.mcichon.repository.UserRepository;
import net.usermd.mcichon.security.AuthoritiesConstants;
import net.usermd.mcichon.service.MailService;
import net.usermd.mcichon.service.dto.UserDTO;
import net.usermd.mcichon.web.rest.errors.ExceptionTranslator;
import net.usermd.mcichon.web.rest.vm.KeyAndPasswordVM;
import net.usermd.mcichon.web.rest.vm.ManagedUserVM;
import net.usermd.mcichon.service.UserService;
