...
class CustomerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Customer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/customers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "document":"SAMPLE_TEXT", "pesel":"SAMPLE_TEXT", "phoneNumber":"SAMPLE_TEXT", "email":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
