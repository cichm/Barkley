...
import net.usermd.mcichon.domain.Customer;

import net.usermd.mcichon.repository.CustomerRepository;
...
import net.usermd.mcichon.service.mapper.CustomerMapper;
